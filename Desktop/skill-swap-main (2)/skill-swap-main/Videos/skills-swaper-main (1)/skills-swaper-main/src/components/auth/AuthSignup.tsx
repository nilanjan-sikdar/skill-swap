...
export const AuthSignup = ({ onSwitchToLogin, onSignupSuccess }: AuthSignupProps) => {
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Join SkillSync and start learning together</p>
      </div>
